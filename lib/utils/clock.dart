...
class Clock {
  ...
  static String getDefaultDateTimeFormatted(DateTime datetime) => ddMMyyyy.format(datetime);

  static String getDateTimeFormatted(DateTime datetime, String pattern) => DateFormat(pattern).format(datetime);
}